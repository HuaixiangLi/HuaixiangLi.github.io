...
<div style="display: flex; align-items: center; gap: 24px; flex-wrap: wrap; margin-top: 20px; margin-bottom: 20px;">
...
My research focuses on **heterogeneous catalysis**, especially **propane dehydrogenation (PDH)**, **non-precious metal catalysts**, **defect engineering**, and **structure–activity relationships**. I am particularly interested in designing stable and selective catalysts by regulating metal active sites, support defects, electronic structures, and metal–support interactions.

Currently, my work mainly explores **Ni-based catalysts for propane dehydrogenation**, with an emphasis on improving catalytic activity, propylene selectivity, and resistance to carbon deposition and sintering under high-temperature reaction conditions. I am also interested in extending these catalyst design strategies to **CO₂ valorization**, including the reverse water–gas shift reaction and CO₂ hydrogenation.
...
<img src="images/profile.jpg" alt="Huaixiang Li" style="width: 200px; border-radius: 16px;">
</div>
...
- **Defect engineering and oxygen vacancies**
- **Metal–support interactions**
- **Structure–activity relationships**
- **In-situ DRIFTS and reaction mechanism analysis**
- **CO₂ valorization and reverse water–gas shift reaction**
...
<img src='images/pdh-b-ni-defect.png' alt="Boron-regulated Ni-based catalysts for PDH" width="100%">
</div>
</div>
...
**Huaixiang Li**, T. Zhang, Z. Tao, Y. Ling, S. Zhong, H. Wang, Y. Li, D. He, and Y. Luo
...
<img src='images/rwgs-ga-h.png' alt="Ga-H active sites for RWGS" width="100%">
</div>
</div>
...
Z. Tao, **Huaixiang Li**, D. He, Z. Huang, J. Liang, J. Dong, X. Cao, and Y. Luo

*Chemical Engineering Journal*, 2025. **Accepted**

This work identifies Gaδ⁺–H species as key active sites for the reverse water–gas shift reaction over Ga/Al₂O₃ catalysts. In this study, I contributed to the in-situ DRIFTS analysis and mechanistic interpretation of surface intermediate evolution under reaction atmospheres.
...
*Project Manager | Supervisor: Prof. Dedong He*  
*Apr. 2025 – Present*
...
*Core Member | Supervisor: Prof. Dedong He*  
*Sept. 2024 – Present*
